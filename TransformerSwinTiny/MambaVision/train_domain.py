"""
Example usage:
  cd /storage2/ChangeDetection/NSST-mamba/Mamba-Segmentation/MambaVision
  python train_domain.py --variant tiny  --domain urban --gpu 0 --amp 1
  python train_domain.py --variant tiny  --domain rural --gpu 0 --amp 1
  python train_domain.py --variant small --domain urban --gpu 1 --amp 1
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Domain-specific training wrapper for MambaVision UrbanMamba.")
    ...
    output_dir = _build_output_dir(args.out_root, "mambavision", args.variant, args.domain, args.crop, args.tag)
    ...
    cfg = Config(
        ...
        WEIGHTS_PATH="auto",
        MAMBAVISION_VARIANT=args.variant,
    )
