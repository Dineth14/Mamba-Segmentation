"""
MambaVision segmentation model (UrbanMamba-style).
...
class MambaVisionSegmentation(nn.Module):
    """
    RGB-only MambaVision segmentation model.
    """

    def __init__(
        self,
        num_classes: int = 7,
        encoder_dims: Tuple[int, ...] = (128, 256, 512, 1024),
        decoder_channels: int = 256,
        drop_path_rate: float = 0.3,
        encoder_depths: Tuple[int, ...] = (3, 3, 10, 5),
