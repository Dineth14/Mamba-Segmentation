"""
Domain-specific training wrapper for CNN_U-Net (ResNet50).
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Domain-specific training for CNN_UNet.")
    ...
    if args.variant != "resnet50":
        raise ValueError("CNN_UNet uses ResNet50 only.")

    paths = _domain_paths(args.domain)
    output_dir = _build_output_dir(args.out_root, "cnn_unet", args.variant, args.domain, args.crop, args.tag)
