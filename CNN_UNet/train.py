"""
train.py — Iteration-based training loop for CNN_UNet.
...
def setup_logging(output_dir: str) -> logging.Logger:
    ...
    # Create logger
    logger = logging.getLogger("CNN_UNet")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train CNN_UNet segmentation.")
    parser.add_argument(
        "--config",
        default="loveda",
