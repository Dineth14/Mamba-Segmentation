...
class Config:
    ...
    SPATIALMAMBA_VARIANT: str = "tiny"
    # Auto-populated from maps based on SPATIALMAMBA_VARIANT
    SPATIALMAMBA_DEPTHS: Tuple[int, ...] = (2, 4, 8, 4)
    SPATIALMAMBA_DIMS: Tuple[int, ...] = (64, 128, 256, 512)
    SPATIALMAMBA_DROP_PATH: float = 0.2
    
    # Decoder
    DECODER_CHANNELS: int = 256
    
    # ============== Optimization ==============
    LR_BACKBONE: float = 6e-5  # Spatial-Mamba backbone learning rate
