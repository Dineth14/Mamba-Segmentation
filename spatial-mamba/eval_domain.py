...
# cd spatial-mamba
# python eval_domain.py --variant small --ckpt /storage2/ChangeDetection/NSST-mamba/Mamba-Segmentation/Comparison_Experiments/spatialmamba_small_512/checkpoints/best.pth --domain rural --split val --gpu 0 --amp 1 --append_csv ../Comparison_Experiments/spatial-mamba_tiny/domain_results.csv
"""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--variant", required=True, help="Spatial-Mamba variant (tiny/small/base)")
...
def main() -> None:
    ...
    cfg = Config(SPATIALMAMBA_VARIANT=args.variant, DATA_ROOT=args.data_root)
    cfg.GPU_ID = args.gpu
