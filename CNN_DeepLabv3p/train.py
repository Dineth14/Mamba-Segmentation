"""
train.py — Iteration-based training loop for CNN_DeepLabv3p.
...
def setup_logging(output_dir: str) -> logging.Logger:
    ...
    # Create logger
    logger = logging.getLogger("CNN_DeepLabv3p")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train CNN_DeepLabv3p segmentation.")
    parser.add_argument(
        "--config",
        default="loveda",
